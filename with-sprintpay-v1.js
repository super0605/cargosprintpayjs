...
// <button class="with-sprintpay__button" callbackUrl="https://vector.ai">PayWithSprintPay</button>
...
function createIframe(modalInstance) {
  ...
  // const iPath = `http://localhost:4201/login-with-sprintpay?returnUrl=${callbackUrl}`;
  const iPath = `https://cargosprint-popup.firebaseapp.com/login-with-sprintpay?returnUrl=${callbackUrl}`;
